...
await member.roles.remove('814859468332073000')
await member.roles.remove('814859470134837268')
await member.roles.remove('814859467543281704')
await member.roles.remove('814859469213007912')
await member.roles.add('814859471817932831')//kayıtsız rol id yaz
message.channel.send(new MessageEmbed().setImage(`https://media.discordapp.net/attachments/697145772801785876/716671769355747348/1.gif`).setFooter(`Developed By RedZenom`).setDescription(`${member} **Adlı Kullanıcı** ${message.author} **Tarafından Kayıtsız'a Atıldı !** \n**Verilen Rol:** <@&814859471817932831>`)).then(msg => msg.delete({timeout: 4000}))}
